...
public class MusinsaCrawler implements Crawler {
    ...
    @Override
    public CrawledResult crawling(String category) {
        log.info("crawling scheduler is started");

        List<ProductDto> productList = new ArrayList<>();
        List<PriceDto> priceList = new ArrayList<>();

        log.info("crawling scheduler is crawling -> " + category);
